            ...
            <div className='project'>
                ...
                <div style={{ marginBottom: 4 + 'em' }}>
                    ...
                    <div style={{ display: 'flex', maxWidth: 50 + 'em', marginLeft: 3 + 'em' }}>
                        <img src='https://media.giphy.com/media/SqYdjEw2GOctNnV5n6/giphy.gif' alt='Treatment Update' style={{ height: 478 + 'px', width: 426 + 'px', objectFit: 'cover' }}></img>
                    ...
                    <div style={{ display: 'flex', width: 50 + 'em', marginTop: 4 + 'em', marginLeft: 3 + 'em', marginBottom: 4 + 'em' }}>
                        ...
                        <img src='https://media.giphy.com/media/Xa9nmWAXnrYATRLsGZ/giphy.gif' alt='Medication Time' style={{ height: 478 + 'px', width: 426 + 'px', objectFit: 'cover' }}></img>
                    </div>
                    <div style={{ display: 'flex', maxWidth: 50 + 'em', marginLeft: 3 + 'em', marginBottom: 4 + 'em' }}>
                        <img src='https://media.giphy.com/media/KEeDvBV4z6CJpE58Rl/giphy.gif' alt='Symptom Definition' style={{ height: 478 + 'px', width: 426 + 'px', objectFit: 'cover' }}></img>
                        <div style={{ flexDirection: 'column' }}>
                    ...
                    <div style={{ display: 'flex', width: 50 + 'em', marginTop: 4 + 'em', marginLeft: 3 + 'em', marginBottom: 4 + 'em' }}>
                        ...
                        <img src='https://media.giphy.com/media/fZ98kbcBoOvtPQUlYW/giphy.gif' alt='Logging a Symptom' style={{ height: 478 + 'px', width: 426 + 'px', objectFit: 'cover' }}></img>
                    </div>
                    <div style={{ display: 'flex', maxWidth: 50 + 'em', marginLeft: 3 + 'em' }}>
                        <img src='https://media.giphy.com/media/KziYiCrHSQMasNr1xI/giphy.gif' alt='Severe Symptoms' style={{ height: 478 + 'px', width: 426 + 'px', objectFit: 'cover' }}></img>
                        <div style={{ flexDirection: 'column' }}>
                    ...
                    <div style={{ display: 'flex', width: 50 + 'em', marginTop: 4 + 'em', marginLeft: 3 + 'em', marginBottom: 4 + 'em' }}>
                        ...
                        <img src='https://media.giphy.com/media/gIBWcWqFB6aE9Vl1RA/giphy.gif' alt='Test Strip Upload' style={{ height: 478 + 'px', width: 426 + 'px', objectFit: 'cover' }}></img>
                    </div>
                    <div style={{ display: 'flex', maxWidth: 50 + 'em', marginLeft: 3 + 'em' }}>
                        <img src='https://media.giphy.com/media/Y34FaKHS9FdjvZIt5o/giphy.gif' alt='Test Strip Upload Later' style={{ height: 470 + 'px', width: 426 + 'px', objectFit: 'cover' }}></img>
                        <div style={{ flexDirection: 'column' }}>
                ...
                <div className='project-links'>
                    <a href='/project2'>Next Project: UWConnect ›</a>
                </div>
